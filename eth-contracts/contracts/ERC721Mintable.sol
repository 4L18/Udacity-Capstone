...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(Address.isContract(newOwner) == false, "Address must be a user account.");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    function setPaused(bool mode) public onlyOwner {
        require(_paused != mode, "That is already the current mode");
        _paused = mode;
        if(_paused) {
            emit Paused();
        } else {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "The given address is already the token's owner");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(_isApprovedOrOwner(msg.sender, tokenId) || isApprovedForAll(msg.sender, to), "Message sender must be contract owner or to be approved for all");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        //fix. What are requirements to be valid?
        //require(true, "The given address is not valid");

        // TODO mint tokenId to given address & increase token count of owner
        _mint(to, tokenId);

        // TODO emit Transfer event
        // fix from is == msg.sender?
        // emit Transfer(address indexed from, to, tokenId);
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From address does not match owner address");

        // TODO: require token is being transfered to valid address
        //fix. What are requirements to be valid?
        //require(to == validAddr, "Receiver's address is not valid");
        ...
        Counters.increment(_ownedTokensCount[from]);
...
contract CustomERC721Token is ERC721Metadata {
    ...
    string baseURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";
